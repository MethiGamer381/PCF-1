...
export class GlowingText24 implements ComponentFramework.StandardControl<IInputs, IOutputs> {
public glowingtext : HTMLElement;
    /**
     * Empty constructor.
     */
    constructor()
    ...
    public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
    {
        ...
        if(context.parameters.MethiGamer1.raw){
            this.glowingtext.innerHTML=context.parameters.MethiGamer1.raw;
